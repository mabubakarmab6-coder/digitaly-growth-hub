...
const cards = [
  {
    ...
    copy: "Build a stronger digital presence, generate better enquiries and create a more reliable acquisition system.",
    image: manufacturing,
  ...
  },
  {
    ...
    copy: "Improve visibility, customer acquisition, conversion and online growth.",
    image: ecommerce,
...
export function WhoWeHelp() {
  return (
    <section id="who-we-help" className="section-y border-y border-hairline bg-surface/60">
      <div className="container-page">
        <Reveal className="max-w-2xl">
          <p className="eyebrow">Who we help</p>
          <h2 className="mt-4 text-3xl leading-[1.15] font-semibold text-foreground sm:text-4xl lg:text-[2.6rem]">
            Built for different businesses. Designed around their reality.
          </h2>
        </Reveal>
